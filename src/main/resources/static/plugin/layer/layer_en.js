  ...
  return layer.open($.extend({
    ...
    ,yes: function(index){
      ...
      if(value === ''){
        ...
        layer.tips('Max input for '+ (options.maxlength || 500) +' characters.', prompt, {tips: 1});
      } else {
        yes && yes(value, index, prompt);
      }
    }
...
layer.photos = function(options, loop, key){
  ...
  loadImage(data[start].src, function(img){
    ...
    layer.close(dict.loadi);
    layer.msg('The url for current picture is invalid <br/>See the next picture?', {
      time: 30000, 
      btn: ['Next', 'Cancel'], 
      yes: function(){
